...
public class Music {
    ...
    public static List<Music> getList(){
        ...
        music1.setName("Godzilla");
        music1.setCoverResId(R.drawable.eminemcover);
        music1.setArtistResId(R.drawable.eminem);
        music1.setMusicFileResId(R.raw.music_1);

        Music music2=new Music();
        music2.setArtist("Linkin park");
        music2.setName("Burn it down");
        music2.setCoverResId(R.drawable.linkinparkcover);
        music2.setArtistResId(R.drawable.linkinpark);
        music2.setMusicFileResId(R.raw.music_2);

        Music music3=new Music();
        music3.setArtist("Madonna");
        music3.setName("Celebration");
        music3.setCoverResId(R.drawable.madonnacover);
        music3.setArtistResId(R.drawable.madonna);
